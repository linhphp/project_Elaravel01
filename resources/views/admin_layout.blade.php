...
<!-- //calendar -->
<!-- //font-awesome icons -->
{{-- <link rel="stylesheet" href="backend/fonts/all.css"> --}}
...
{{-- <script src="backend/fonts/all.js"></script> --}}
    ...
    @if(Auth::check())
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{ route('admin_logout') }}"><i class="fa fa-key"></i>Đăng xuất</a></li>
            </ul>
        </li>
    @endif
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('danh-muc-san-pham.create') }}">Thêm danh mục sản phẩm</a></li>
						<li><a href="{{ route('danh-muc-san-pham.index') }}">liệt kê danh sách sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
                    ...
                    <ul class="sub">
						<li><a href="{{ route('thuong-hieu-san-pham.create') }}">Thêm thương hiệu sản phẩm</a></li>
						<li><a href="{{ route('thuong-hieu-san-pham.index') }}">danh sách thương hiệu sản phẩm</a></li>
                    </ul>
                </li>
                <li class="sub-menu">
                    <a href="javascript:;">
