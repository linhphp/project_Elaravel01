...
<!DOCTYPE html>
<head>
<title>trang quan ly admin web</title>
...
<base href="{{ asset('') }}">
<!-- bootstrap-css -->
<link rel="backend/stylesheet" href="css/bootstrap.min.css" >
<!-- //bootstrap-css -->
<!-- Custom CSS -->
...
<!-- font-awesome icons -->
<link rel="backend/stylesheet" href="css/font.css" type="text/css"/>
...
<div class="w3layouts-main">
	...
	<p class="danger">{{ Session::get('message') }}</p>
	@endif
		<form action="{{ route('admin_dashboard') }}" method="post">
			@method('post')
			@csrf
			<input type="text" class="ggg" name="email" placeholder="nhập email của bạn
			" required="">
		...
		<p>không có tài khoản?<a href="registration.html">Tạo một tài khoản</a></p>
</div>
</div>
